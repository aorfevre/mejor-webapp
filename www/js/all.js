...
(function(app) {
    ...
    app.controller('AccountCtrl',
        ...
        ["$scope", "$gpsService", "$tools", "toaster", "$state", "$apiService", "$timeout", function($scope, $gpsService, $tools, toaster, $state, $apiService,$timeout) {
...
(function(app) {
    ...
    app.controller('AppCtrl',
        ...
        ["$scope", "$rootScope", "$apiService", "toaster", "$state", function($scope, $rootScope, $apiService,toaster,$state) {
            ...
            $scope.getPlanByEmail = function(email) {
                ...
                $apiService.getUser(email).then(function(res){
                	...
                	if(res.status === 204){
                        ...
                        $('#myModal').modal('hide');
                		$state.transitionTo('app.account', {email: email,myAccount: res.data })
                	}
                },function(err){
                    $('#myModal').modal('hide');
                	toaster.pop({
...
(function(app) {
    ...
    app.controller('HomeCtrl',
        ...
        ["$scope", "$gpsService", "$apiService", "$tools", "toaster", function($scope,  $gpsService, $apiService, $tools, toaster) {
...
(function(app) {
    ...
    app
        .factory('$apiService',
            ...
            //{{
            ["$q", "$log", "$http", "$window", function($q, $log, $http, $window) {
